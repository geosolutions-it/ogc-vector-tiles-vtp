...
const {changeLayerProperties, changeGroupProperties, toggleNode, contextNode,
    ...
    download} = require('@mapstore/actions/layers');
const {openQueryBuilder} = require("@mapstore/actions/layerFilter");
const {getLayerCapabilities} = require('@mapstore/actions/layerCapabilities');
const {zoomToExtent} = require('@mapstore/actions/map');
const {error} = require('@mapstore/actions/notifications');
const {groupsSelector, layersSelector, selectedNodesSelector, layerFilterSelector, layerSettingSelector, layerMetadataSelector, wfsDownloadSelector} = require('@mapstore/selectors/layers');
const {mapSelector, mapNameSelector} = require('@mapstore/selectors/map');
const {currentLocaleSelector} = require("@mapstore/selectors/locale");
const {widgetBuilderAvailable} = require('@mapstore/selectors/controls');
const {generalInfoFormatSelector} = require("@mapstore/selectors/mapInfo");
...
const { setControlProperties} = require('@mapstore/actions/controls');
const {createWidget} = require('@mapstore/actions/widgets');

const {getMetadataRecordById} = require("@mapstore/actions/catalog");

const {activeSelector} = require("@mapstore/selectors/catalog");
...
const TOC = require('@mapstore/components/TOC/TOC');
const Header = require('@mapstore/components/TOC/Header');
const Toolbar = require('@mapstore/components/TOC/Toolbar');
const DefaultGroup = require('@mapstore/components/TOC/DefaultGroup');
const DefaultLayer = require('@mapstore/components/TOC/DefaultLayer');
...
const API = {
    csw: require('@mapstore/api/CSW'),
    wms: require('@mapstore/api/WMS'),
    wmts: require('@mapstore/api/WMTS'),
    backgrounds: require('@mapstore/api/mapBackground')
};
...
module.exports = {
    ...
    reducers: {
        queryform: require('@mapstore/reducers/queryform'),
        query: require('@mapstore/reducers/query')
    },
    epics: require("@mapstore/epics/catalog").default(API)
};
